...
namespace Mera.Quiz.UI
{
	public partial class LoginForm : Form
	{
		...
		private async void loginbtn_ClickAsync(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show(except.Message, "Login failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
		...
		private async void registerlbl_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
		{
			...
			catch (Exception except)
			{
				...
				MessageBox.Show(except.Message, "Registration of new user failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
		}
